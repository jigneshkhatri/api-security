 ...
 * 
 */
package in.quallit.apisecurity.utilities;
...
import in.quallit.apisecurity.constants.Constants;
...
//		return ObjectUtil.isNotEmpty(currentUser) ? currentUser.getId() : null;
//	}
